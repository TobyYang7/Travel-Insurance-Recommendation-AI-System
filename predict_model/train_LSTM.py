...
def main(delay_index=0):  # Select arr or dep
    ...
    model = LSTMNet(in_c=2*args.in_len, hid_c=args.lstm_hidden_size,
    ...
    for ep in trange(n_epochs):
        ...
        if delay_index == 0:
            writer.add_scalar('LSTM/arr_loss', loss, ep)
        if delay_index == 1:
            writer.add_scalar('LSTM/dep_loss', loss, ep)
        ...
        if (loss < best_loss):
            old_arr_model_path = f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/arr/LSTM_pretrained_ep{best_ep}.pth'
            old_dep_model_path = f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/dep/LSTM_pretrained_ep{best_ep}.pth'
            old_arr_npz_path = f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/arr/arr_{best_ep}.npz'
            old_dep_npz_path = f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/dep/dep_{best_ep}.npz'
            ...
            if delay_index == 0:
                ...
                torch.save(model.state_dict(), f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/arr/LSTM_pretrained_ep{ep}.pth')
                np.savez(f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/arr/arr_{ep}.npz', predict=yhat, true=label)
            ...
            if delay_index == 1:
                ...
                torch.save(model.state_dict(), f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/dep/LSTM_pretrained_ep{ep}.pth')
                np.savez(f'/home/zhangmin/toby/IBA_Project_24spr/saves/LSTM/dep/dep_{ep}.npz', predict=yhat, true=label)
    ...
    print(f"Error of LSTM in 3-step: (MAE: {best_metrics['amae3']}, RMSE: {best_metrics['armse3']}, MAPE: {best_metrics['amape3']})")
    print(f"Error of LSTM in 6-step: (MAE: {best_metrics['amae6']}, RMSE: {best_metrics['armse6']}, MAPE: {best_metrics['amape6']})")
    print(f"Error of LSTM in 12-step: (MAE: {best_metrics['amae12']}, RMSE: {best_metrics['armse12']}, MAPE: {best_metrics['amape12']})")
    print("---------------------------------------------------------------------------------------")
    print(f"Error of LSTM in 3-step: ({round(amae3[best_ep],3)}, {round(armse3[best_ep],3)}, {round(amape3[best_ep],3)})")
    print(f"Error of LSTM in 6-step: ({round(amae6[best_ep],3)}, {round(armse6[best_ep],3)}, {round(amape6[best_ep],3)})")
    print(f"Error of LSTM in 12-step: ({round(amae12[best_ep],3)}, {round(armse12[best_ep],3)}, {round(amape12[best_ep],3)})")
